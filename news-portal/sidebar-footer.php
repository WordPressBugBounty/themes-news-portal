 ...
 */
    ...
    $news_portal_footer_widget_option = news_portal_get_customizer_option_value( 'news_portal_footer_widget_option' );

    if ( $news_portal_footer_widget_option == false ) {
        return;
    }
    ...
    $news_portal_footer_layout = news_portal_get_customizer_option_value( 'footer_widget_layout' );
?>
