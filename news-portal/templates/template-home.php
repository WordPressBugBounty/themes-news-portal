...
<?php 
	...
	$news_portal_home_template_content_option = news_portal_get_customizer_option_value( 'news_portal_home_template_content_option' );
	if ( true === $news_portal_home_template_content_option ) {
		/**
