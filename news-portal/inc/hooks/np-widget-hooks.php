...
if ( ! function_exists( 'news_portal_widget_title_callback' ) ) :
	...
	function news_portal_widget_title_callback( $news_portal_title_args ) {
		...
		$news_portal_title_cat_link  = news_portal_get_customizer_option_value( 'news_portal_widget_cat_link_option' );
		$news_portal_title_cat_color = news_portal_get_customizer_option_value( 'news_portal_widget_cat_color_option' );
		if ( $news_portal_title_cat_color == true ) {
			$title_class = 'np-title np-cat-'. $news_portal_block_cat_id;
		} else {
			$title_class = 'np-title';
		}
		
		if ( !empty( $news_portal_block_cat_id ) && $news_portal_title_cat_link == true ) {
