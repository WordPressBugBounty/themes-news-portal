...
if ( ! function_exists( 'news_portal_related_posts_section' ) ) :
	...
	function news_portal_related_posts_section() {
		$news_portal_related_option = news_portal_get_customizer_option_value( 'news_portal_related_posts_option' );
		...
		if ( $news_portal_related_option == false || empty( $categories ) ) {
			return;
		}
		$news_portal_related_title = news_portal_get_customizer_option_value( 'news_portal_related_posts_title' );
