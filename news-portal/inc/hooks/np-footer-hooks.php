...
?>
		<div class="site-info">
			<span class="np-copyright-text">
				<?php 
					$news_portal_copyright_text = news_portal_get_customizer_option_value( 'news_portal_copyright_text' );
...
if ( ! function_exists( 'news_portal_go_top' ) ) :
	...
	function news_portal_go_top() {
		...
		$np_scroll_top = news_portal_get_customizer_option_value( 'news_portal_scroll_top_option' );

		if ( $np_scroll_top == false ) {
			return;
		} 
