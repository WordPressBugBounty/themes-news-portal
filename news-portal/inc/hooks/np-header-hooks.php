...
if ( ! function_exists( 'news_portal_top_left_section' ) ) :
	...
	function news_portal_top_left_section() {
		$news_portal_date_option = news_portal_get_customizer_option_value( 'news_portal_top_date_option' );
?>
		<div class="np-top-left-section-wrapper">
			<?php
				if ( $news_portal_date_option == true ) {
...
?>
		<div class="np-top-right-section-wrapper">
			<?php
				$news_portal_top_social_option = news_portal_get_customizer_option_value( 'news_portal_top_social_option' );
				if ( $news_portal_top_social_option == true ) {
...
if ( ! function_exists( 'news_portal_ticker_content' ) ) :
	...
	*/
	function news_portal_ticker_content() {
		$news_portal_ticker_caption = news_portal_get_customizer_option_value( 'news_portal_ticker_caption' );
?>
